				...
				<div class="col-sm-6 border-right">
					...
					<div class="form-group">
						...
						<select name="type" id="type" class="custom-select custom-select-sm">
							...
							<?php endif; ?>
							<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected' : '' ?>>Respuesta Sencila/Botón Círculo</option>
							<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected' : '' ?>>Respuesta Multiple/Cuadros de Chequeo</option>
